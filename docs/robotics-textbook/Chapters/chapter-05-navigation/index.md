...
We now have models, estimators and planners, both global and local. Next, we look at more complex articulated robots.

→ [Chapter 6: Kinematics](../chapter-06-kinematics/index.md)
